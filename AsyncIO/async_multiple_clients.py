...
hosts = [
    {'host': '192.168.1.48', 'username': 'u1', 'password': 'test123', 'command': 'ifconfig'},
    #I have a single linux vm so I'm gonna spawn an ssh task that runs a command on the same host
    {'host': '192.168.1.48', 'username': 'u1', 'password': 'test123', 'command': 'whox -a'},
    {'host': '192.168.1.48', 'username': 'u1', 'password': 'test1234', 'command': 'uname -a'}
]
